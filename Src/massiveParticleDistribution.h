...
public:
	...
	static void evaluateDistributionAdvectionWithLosses(const double& mass, double* energy, double* distribution, double** outDistribution, const int Ne, const int Nx, double* x, double advectionV, double* B, int Nph, double* Uph, double* Eph);
	static void evaluateDistributionAdvectionWithLossesAnalytic(const double& mass, double* energy, double* distribution, double** outDistribution, const int Ne, const int Nx, double* x, double advectionV, double* B, int Nph, double* Uph, double* Eph);
	...
	static void evaluateDistributionDiffusionAdvectionWithLosses(const double& mass, double* energy, double* distribution, double**& outDistribution, const int Ne, const int Nx, double* x, double advectionV, double* B, int Nph, double* Uph, double* Eph);

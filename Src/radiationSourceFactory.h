...
public:
	...
	static TabulatedDiskSource* readSourceFromFile(MassiveParticleDistribution* electronDistribution, const double& rhomin, const double& rhomax, const double& zmin, const double zmax, const int Nrho, const int Nz, const int Nphi, const double& distance, SourceInputGeometry geometry, const char* BFileName, const char* concentrationFileName, const double& thetar, const double& phir, const double& psir);

...
int main() {
	...
	ElectronPowerLawDistribution* electrons = new ElectronPowerLawDistribution(3.5, me_c2, 150);
	...
	for (int i = 0; i < Nnu; ++i) {
		...
		I[i] = evaluator.evaluateComptonLuminocityIsotropicFunction(E[i], CMBradiation, electrons, volume, distance);
	}

...
%data = importdata('../output/thickDistribution.dat');
...
for i = 1:endPower-startPower + 1,
   polyfitx(i) = log(data(i+startPower-1,1));
    ...
    polyfity(i) = log(data(i+startPower-1,2));
end;
p = polyfit(polyfitx, polyfity, 1);

for i = startPower:endPower,

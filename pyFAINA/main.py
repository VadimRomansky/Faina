...
from plot_V4641_EFE_higenergy import plot_V4641_EFE_highenergy
...
if __name__ == '__main__':
    ...
    plot_V4641_EFE_highenergy5("../output/V4641synchandcompt0.1.dat", "../output/V4641synchandcompt0.3.dat","../output/V4641synchandcompt0.5.dat","../output/V4641synchandcompt1.0.dat","../output/V4641synchandcompt2.0.dat", "V4641compton5", factor)
    ...
    plot_V4641_profile5("../output/chandraprofile0.1.dat", "../output/chandraprofile0.3.dat", "../output/chandraprofile0.5.dat", "../output/chandraprofile1.0.dat", "../output/chandraprofile2.0.dat", "V4641profile5")

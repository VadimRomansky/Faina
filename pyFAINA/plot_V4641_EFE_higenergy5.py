...
def plot_V4641_EFE_highenergy5(filename1,filename2,filename3,filename4,filename5, name, factor = 1.0):
    ...
    radiationFile4 = open(filename4, 'r')
    lines4 = radiationFile4.readlines()
    N4 = len(lines4)

    radiation4 = np.zeros([2, N4])
    # radiation5 = np.zeros([2, N1])
    for i in range(N4):
        s = lines4[i].split()
        radiation4[0, i] = float(s[0])
        radiation4[1, i] = factor * float(s[1])
        # radiation5[0, i] = float(s[0])
        # radiation5[1, i] = factor * float(s[4])
        # radiation[2,i] = float(s[2])

    radiationFile5 = open(filename5, 'r')
    lines5 = radiationFile5.readlines()
    N5 = len(lines5)

    radiation5 = np.zeros([2, N5])
    # radiation5 = np.zeros([2, N1])
    for i in range(N5):
        s = lines5[i].split()
        radiation5[0, i] = float(s[0])
        radiation5[1, i] = factor * float(s[1])
        # radiation5[0, i] = float(s[0])
        # radiation5[1, i] = factor * float(s[4])
        # radiation[2,i] = float(s[2])
    ...
    plt.xticks(
        [5E10, 6E10, 7E10, 8E10, 9E10, 1E11, 2E11,
         ...
         3E13, 4E13, 5E13, 6E13, 7E13, 8E13, 9E13, 1E14, 2E14, 3E14, 4E14, 5E14, 6E14, 7E14, 8E14, 9E14, 1E15, 2E15, 3E15, 4E15, 5E15, 6E15, 7E15, 8E15, 9E15, 1E16])
    #plt.xticks([1E3, 2E3, 3E3, 4E3, 5E3, 6E3, 7E3, 8E3, 9E3, 1E4, 2E4, 3E4, 4E4, 5E4])
    plt.yticks([2E-14, 3E-14, 4E-14, 5E-14, 6E-14, 7E-14, 8E-14, 9E-14, 1E-13, 2E-13, 3E-13, 4E-13, 5E-13, 6E-13, 7E-13, 8E-13, 9E-13, 1E-12, 2E-12, 3E-12, 4E-12, 5E-12, 6E-12, 7E-12, 8E-12, 9E-12, 1E-11, 2E-11, 3E-11, 4E-11, 5E-11])

    plt.plot(radiation1[0], radiation1[1], 'r', linewidth=2, label = '0 years')
    plt.plot(radiation2[0], radiation2[1], 'g', linewidth=2, label = '200 years')
    plt.plot(radiation3[0], radiation3[1], 'b', linewidth=2, label = '500 years')
    plt.plot(radiation4[0], radiation4[1], 'orange', linewidth=2, label = '1000 years')
    plt.plot(radiation5[0], radiation5[1], 'salmon', linewidth=2, label = '3000 years')

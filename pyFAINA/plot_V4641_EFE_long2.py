...
def plot_V4641_EFE_long2(filename1, filename2, name, factor = 1.0, factor2 = 1.0):
   ...
   #      3E13, 4E13, 5E13, 6E13, 7E13, 8E13, 9E13, 1E14, 2E14, 3E14, 4E14, 5E14, 6E14, 7E14, 8E14, 9E14, 1E15])
    ...
    plt.errorbar(integral[0, :], integral[1, :], xerr=[integral[2, :], integral[3, :]], yerr=[integral[4, :], integral[5, :]], marker='s', markerfacecolor='pink',
                 markeredgecolor='pink', markersize=3.5, ecolor='pink', elinewidth=1.5, linewidth=0,

...
def plot_V4641_EFE_long5(filename1, filename2, filename3, filename4, filename5, name, factor = 1.0):
   ...
   #      3E13, 4E13, 5E13, 6E13, 7E13, 8E13, 9E13, 1E14, 2E14, 3E14, 4E14, 5E14, 6E14, 7E14, 8E14, 9E14, 1E15])
    ...
    plt.plot(radiation1[0], radiation1[1], 'r', linewidth=2, label = 'L0 = 1E17')
    plt.plot(radiation2[0], radiation2[1], 'g', linewidth=2, label = 'L0 = 3E17')
    plt.plot(radiation3[0], radiation3[1], 'b', linewidth=2, label='L0 = 5E17')
    plt.plot(radiation4[0], radiation4[1], 'orange', linewidth=2, label='L0 = 1E18')
    plt.plot(radiation5[0], radiation5[1], 'salmon', linewidth=2, label='L0 = 2E18')

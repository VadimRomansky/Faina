...
def plot_distributions2():
    Efile0e = open('../examples_data/gamma0.66_combined/Ee3.dat','r').readline().split()
    Ffile0e= open('../examples_data/gamma0.66_combined/Fs3.dat','r').readline().split()

    Efile0p = open('../examples_data/gamma0.66_combined_protons/Ee3.dat', 'r').readline().split()
    Ffile0p = open('../examples_data/gamma0.66_combined_protons/Fs3.dat', 'r').readline().split()
    ...
    ax.set_ylim(ymin=0.2E-6, ymax=0.5)

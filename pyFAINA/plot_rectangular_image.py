...
def plot_rectangular_image(filename, name):
    ...
    im2 = plt.imshow(radiation.T, origin = 'lower', norm = colors.LogNorm(vmin = minradiation, vmax = amax(radiation)), aspect = 'equal', extent = [minX, maxX, minY, maxY])

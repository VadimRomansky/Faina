...
\input{part1}			% Глава 1. источники излучения
\input{part2}           % Глава 2. Расчет излучения
\input{part3}			% Глава 2. Оптимизация параметров
\input{part4}			% Глава 3. Формулы расчета излучения
